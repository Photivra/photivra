...
- `partial-foundation` — some low-level science exists, but the full stage contract is not implemented; spatial camera rotation is one current example inside the temporal domain;
